...
public class Introduction_Restaurant extends BaseActivity {

    private ImageButton btn_star, back_btn;
    private APIinterface apIinterface;
    private ImageView back_img, card, carriage, pet;
    private TextView placename, call_inquiry, usetime, holiday, rep_menu, location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.introduction_restaurant);
        ...
        rep_menu = (TextView)findViewById(R.id.rep_menu);
        ...
        apIinterface.getDetail("UserSession=" + dbHelper.getCookie(), (Integer)value).enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if(response.code() == 200) {
                    ...
                    rep_menu.setText(response.body().get("rep_menu").getAsString());
