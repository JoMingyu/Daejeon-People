...
@API(functionCategory = "여행지 정보", summary = "카테고리 없는 여행지 리스트 조회")
@REST(params = "sort_type : int, page : int", responseBody = "content_id : int, title : String, wish : boolean, wish_count : int, address : String, category : String, image : String, mapx : double, mapy : double", successCode = 200, failureCode = 204)
