...
@Function(functionCategory = "사용자", summary = "ID 기반 사용자 정보 조회")
@RESTful(requestBody = "id : String", responseBody = "id : String, phone_number : String, email : String, name : String", successCode = 201)
